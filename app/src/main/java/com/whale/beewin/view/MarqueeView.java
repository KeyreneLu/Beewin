...
public class MarqueeView extends ViewFlipper {
    ...
    private void resetAnimation(){
        ...
        Animation animIn = AnimationUtils.loadAnimation(mContext, R.anim.slide_top_in);
        if (isSetAnimDuration) animIn.setDuration(animDuration);
        setInAnimation(animIn);

        Animation animOut = AnimationUtils.loadAnimation(mContext, R.anim.slide_bottom_out);
...
//    public void updateData(List<? extends CharSequence> notices) {
//        removeAllViews();
//        resetAnimation();
//
//        for (int i = 0; i < notices.size(); i++) {
