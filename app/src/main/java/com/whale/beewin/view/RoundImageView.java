...
public class RoundImageView extends ImageView{
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            borderColor = array.getColor(R.styleable.RoundImageView_ml_border_color, borderColor);
            borderWidth = array.getDimensionPixelOffset(R.styleable.RoundImageView_ml_border_width, borderWidth);
            pressAlpha = array.getInteger(R.styleable.RoundImageView_ml_press_alpha, pressAlpha);
            pressColor = array.getColor(R.styleable.RoundImageView_ml_press_color, pressColor);
            radius = array.getDimensionPixelOffset(R.styleable.RoundImageView_ml_radius, radius);
            shapeType = array.getInteger(R.styleable.RoundImageView_ml_shape_type, shapeType);
            array.recycle();
        }
