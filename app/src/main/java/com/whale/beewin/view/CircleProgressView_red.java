...
public class CircleProgressView_red extends View {
    ...
    public CircleProgressView_red(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        mPaint.setColor(Color.rgb(255, 69, 0));

        //       mPaint.setColor(Color.rgb(47, 162, 220));
