...
public class RegisterActivity extends BaseActivity {
    ...
    void askCode(){
        ...
        TimeCountUtils timeCountUtils = new TimeCountUtils(RegisterActivity.this, 60000, 1000, mBtnAskCode);
        timeCountUtils.start();
        Subscription subscription = wrapper.askCode(phone,code)
    ...
    void userRegister(){
        ...
        String password = mEtUserPassword.getText().toString().trim();
        String mid = mEtInviteCode.getText().toString().trim();
        String mcode = mEtPhoneCode.getText().toString().trim();
        if (phone.isEmpty()){
            showToast("手机号不能为空!");
            return;
        }
        ...
        showLoadingDialog();
        Subscription subscription = wrapper.userRegister(phone,password,mcode,mid)
                .subscribe(newSubscriber(new Action1<Object>() {
                    @Override
                    public void call(Object o) {
